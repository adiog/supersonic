...
template <>
struct SupersonicBeanTable<MetaBean>
{
    TupleSchema schema;
    ...
    void insert(MetaBean& bean)
    {
        ...
        if (bean.meta_hash)
        {
            add_row.String((ValueRef<STRING>(*bean.meta_hash)).value());
        }
        else
        {
            add_row.Null();
        ...
        if (bean.author)
        {
            add_row.String((ValueRef<STRING>(*bean.author)).value());
        }
        else
        {
            add_row.Null();
        ...
        if (bean.created_at)
        {
            add_row.String((ValueRef<STRING>(*bean.created_at)).value());
        }
        else
        {
            add_row.Null();
        ...
        if (bean.icon)
        {
            add_row.String((ValueRef<STRING>(*bean.icon)).value());
        }
        else
        {
            add_row.Null();
        ...
        if (bean.meta_type)
        {
            add_row.String((ValueRef<STRING>(*bean.meta_type)).value());
        }
        else
        {
            add_row.Null();
        ...
        if (bean.modified_at)
        {
            add_row.String((ValueRef<STRING>(*bean.modified_at)).value());
        }
        else
        {
            add_row.Null();
        ...
        if (bean.name)
        {
            add_row.String((ValueRef<STRING>(*bean.name)).value());
        }
        else
        {
            add_row.Null();
        ...
        {
            add_row.String((ValueRef<STRING>(*bean.source_title)).value());
        }
        else
        {
            add_row.Null();
        ...
        if (bean.source_url)
        {
            add_row.String((ValueRef<STRING>(*bean.source_url)).value());
        }
        else
        {
            add_row.Null();
        ...
        if (bean.text)
        {
            add_row.String((ValueRef<STRING>(*bean.text)).value());
        }
        else
        {
            add_row.Null();
        ...
        if (bean.user_hash)
        {
            add_row.String((ValueRef<STRING>(*bean.user_hash)).value());
        }
        else
        {
            add_row.Null();
    ...
    static MetaBean decode(const View& view)
    {
        MetaBean bean;
